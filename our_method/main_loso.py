...
from Multimodal_dataset import build_loaders_loso_binary as build_loaders
...
def get_config():
    ...
    p.add_argument('--data_path', type=str, default='/root/autodl-tmp/eeg/data/DEAP/aligned_independent_data')
